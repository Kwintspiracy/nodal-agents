...
// pleine largeur, deux lignes à vide et grandissant avec le texte ; sous elle
...
export const COMPOSER_ROWS = 2;

/**
 * Le plancher : la zone ne redescend JAMAIS sous ses deux lignes, même vide (deux depuis le 20/09 : une seule était trop basse, trois trop haut).
...
/** La zone épouse son texte : deux lignes à vide, autant qu'il en faut ensuite. */
...
export default function ThreadComposer({
  ...
  // juste au-dessus de la barre d'état. Deux lignes à vide, comme la
  ...
  return (
    ...
    <div className="mx-auto flex w-full max-w-[760px] flex-col gap-2 rounded-xl border border-rule bg-feed-composer px-4 pt-3 pb-2.5">
      <TextArea
        ...
        // `min-h-[40px]` = COMPOSER_MIN_HEIGHT_PX, le plancher de deux lignes
        ...
        className="block max-h-[200px] min-h-[40px] w-full resize-none overflow-y-auto bg-transparent px-0 py-0 text-body-14 placeholder:text-ink-2/70"
      />
