...
export default function BackButton({ href, label = 'Back', className = '' }: Props) {
  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-1.5 border-0 bg-transparent py-2 text-medium-14 leading-none! text-ink-3 transition-colors hover:text-ink ${className}`}
    >
