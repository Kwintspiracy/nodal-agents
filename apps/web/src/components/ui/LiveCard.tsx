...
export default function LiveCard({ runningAgents, throughput, fill = 0.36 }: Props) {
  ...
  return (
    <div className="mx-3 mt-2.5 rounded-[10px] border border-rule-2 bg-paper px-3 pt-2.5 pb-3">
      <div className="flex items-center gap-1.5 font-mono text-[9.5px] uppercase leading-none tracking-[0.14em] text-ink-3">
        <LiveDot variant="lime" />
        Live
      </div>
      <div className="mt-1.5 text-[12.5px] leading-[1.35] text-ink-2">
