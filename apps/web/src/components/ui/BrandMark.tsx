  ...
  return (
    <div className="px-4 pb-3.5">
      <div className="flex items-center gap-2 text-[16px] font-medium leading-none tracking-[-0.005em] text-ink">
        <span className="flex h-[22px] w-[22px] items-center justify-center rounded-md bg-ink text-[12px] font-semibold leading-none tracking-[0.04em] text-canvas font-mono">
          N
        </span>
