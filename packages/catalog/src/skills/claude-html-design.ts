// catalog/skills/claude-html-design.ts — system skill, shipped with the product.
//
...
export const claudeHtmlDesignSkill: SystemSkill = {
  slug: 'claude-html-design',
  name: 'ClaudeHTML-Design',
  description: 'Design one-off HTML artifacts (landing, deck, prototype).',
  requiredBuiltins: [],
  content: `Claude Design for CLI/API Agents
