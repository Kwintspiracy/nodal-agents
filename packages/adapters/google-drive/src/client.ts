 ...
 * that window got a spurious `drive_unauthorized` even though the underlying
 ...
 * DriveAdapterError({ code: 'drive_unauthorized' }).
 */
export function createDriveClient(getAccessToken: () => Promise<string>): drive_v3.Drive {
