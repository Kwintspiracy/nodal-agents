// verification-runs-source.pg.test.ts — migration 0112 contre un VRAI Postgres.
//
...
describe('migration 0112_verification_runs_source @cap:verifier-un-livrable/moteur', () => {
  ...
  it('records the migration in the journal drizzle-kit actually reads', async () => {
    ...
    expect(tags).toContain('0112_verification_runs_source');
  });
});
